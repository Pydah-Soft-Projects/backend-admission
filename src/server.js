...
import joiningPublicRoutes from './routes/joiningPublic.routes.js';
...
import registrationFormRoutes from './routes/registrationForm.routes.js';
...
// Routes
app.use('/api/leads', leadGroupUpdateRoutes);
app.use('/api/auth', authRoutes);
app.use('/api/users', userRoutes);
app.use('/api/leads', leadRoutes);
app.use('/api/communications', communicationRoutes);
app.use('/api/joinings/public', joiningPublicRoutes);
