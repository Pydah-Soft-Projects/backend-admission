...
CREATE TABLE IF NOT EXISTS users (
    ...
    role_name VARCHAR(50) NOT NULL CHECK (role_name IN ('Super Admin', 'Sub Super Admin', 'Student Counselor', 'Data Entry User', 'PRO')),
...
-- ============================================
-- 2b. USER AUDIT LOGS (user-management change history)
-- ============================================
...
CREATE TABLE IF NOT EXISTS leads (
    ...
    assigned_to_pro CHAR(36) NULL,
    pro_assigned_at DATETIME,
    pro_assigned_by CHAR(36) NULL,
    cycle_number INT DEFAULT 1,
    target_date DATE NULL COMMENT 'Legacy combined target; prefer counsellor_target_date / pro_target_date',
    counsellor_target_date DATE NULL,
    pro_target_date DATE NULL,
    source VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS joinings (
    ...
    preferred_mobile_number VARCHAR(20) DEFAULT '' COMMENT 'Preferred SMS/contact mobile from student/father/mother',
    mother_aadhaar_number TEXT,
    father_photo LONGTEXT NULL COMMENT 'Father portrait from registration upload (data URL, URL, or filename)',
    mother_photo LONGTEXT NULL COMMENT 'Mother portrait from registration upload (data URL, URL, or filename)',
    father_occupation VARCHAR(255) DEFAULT '' COMMENT 'Father occupation from joining parents form',
    mother_occupation VARCHAR(255) DEFAULT '' COMMENT 'Mother occupation from joining parents form',
    student_photo LONGTEXT NULL COMMENT 'Student portrait from joining registration upload (data URL, URL, or filename)',
    reservation_general VARCHAR(20) NOT NULL CHECK (reservation_general IN ('oc', 'ews', 'bc-a', 'bc-b', 'bc-c', 'bc-d', 'bc-e', 'sc', 'st')),
    reservation_is_ews BOOLEAN DEFAULT FALSE,
    ...
    qualification_merit TINYINT(1) NULL DEFAULT NULL,
    qualification_ac TINYINT(1) NULL DEFAULT NULL,
...
-- ============================================
-- 6b. JOINING PUBLIC EDIT TOKENS (time-limited magic links)
-- ============================================
...
CREATE TABLE IF NOT EXISTS admissions (
    ...
    mother_name VARCHAR(255) DEFAULT '',
    mother_phone VARCHAR(20) DEFAULT '',
    preferred_mobile_number VARCHAR(20) DEFAULT '' COMMENT 'Preferred contact mobile copied from joining at approval',
    mother_aadhaar_number TEXT,
    father_photo LONGTEXT NULL COMMENT 'Father portrait copied from joining at approval',
    mother_photo LONGTEXT NULL COMMENT 'Mother portrait copied from joining at approval',
    father_occupation VARCHAR(255) DEFAULT '' COMMENT 'Father occupation copied from joining at approval',
    mother_occupation VARCHAR(255) DEFAULT '' COMMENT 'Mother occupation copied from joining at approval',
    student_photo LONGTEXT NULL COMMENT 'Student portrait copied from joining at approval',
    reservation_general VARCHAR(20) NOT NULL CHECK (reservation_general IN ('oc', 'ews', 'bc-a', 'bc-b', 'bc-c', 'bc-d', 'bc-e', 'sc', 'st')),
    reservation_is_ews BOOLEAN DEFAULT FALSE,
    reservation_other JSON DEFAULT (JSON_ARRAY()),
    address_door_street VARCHAR(255) DEFAULT '',
...
-- ============================================
-- 10b. ADMISSION MINIMUM FEE CONFIGS
-- (college + course + quota minimum transaction amounts)
-- ============================================
